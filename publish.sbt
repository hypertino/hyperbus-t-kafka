...
pomExtra :=
  <url>https://github.com/hypertino/hyperbus-t-kafka</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/hyperbus-t-kafka.git</url>
      <connection>scm:git:git@github.com:hypertino/hyperbus-t-kafka.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
